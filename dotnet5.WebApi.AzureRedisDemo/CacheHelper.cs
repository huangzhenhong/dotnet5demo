    ...
    public class CacheHelper
    {
        ...
        private static async Task<ConnectionMultiplexer> CreateConnectionAsync()
        {
            ...
            try
            {
                ...
                string cacheConnection = "NationalCookiesCache1.redis.cache.windows.net:6380,password=XDs5DGO950H1AWcJ8dlwYfLod9g3EyCgXgoumRhexwI=,ssl=True,abortConnect=False";
